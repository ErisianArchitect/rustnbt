...
macro_rules! tag_info_table {
    ($macro:ident) => {
        $macro! {
//ID    Title           Type            [Subtype]       [Origin   ]     [Implementation...]
0001    Byte            i8              [scalar ]       [minecraft]     [$crate::family::Primitive       ]  []
0002    Short           i16             [scalar ]       [minecraft]     [$crate::family::NonBytePrimitive]  []
0003    Int             i32             [scalar ]       [minecraft]     [$crate::family::NonBytePrimitive]  []
0004    Long            i64             [scalar ]       [minecraft]     [$crate::family::NonBytePrimitive]  []
0005    Float           f32             [scalar ]       [minecraft]     [$crate::family::NonBytePrimitive]  []
0006    Double          f64             [scalar ]       [minecraft]     [$crate::family::NonBytePrimitive]  []
0007    ByteArray       Vec::<i8>       [array  ]       [minecraft]     [$crate::family::NonByte         ]  []
0008    String          String          [other  ]       [minecraft]     [$crate::family::NonByte         ]  []
0009    List            ListTag         [other  ]       [minecraft]     [$crate::family::NonByte         ]  []
0010    Compound        Map             [other  ]       [minecraft]     [$crate::family::NonByte         ]  []
0011    IntArray        Vec::<i32>      [array  ]       [minecraft]     [$crate::family::NonByte         ]  []
0012    LongArray       Vec::<i64>      [array  ]       [minecraft]     [$crate::family::NonByte         ]  []
...
0132    Bytes           Vec::<u8>       [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0133    ShortArray      Vec::<i16>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0134    UShortArray     Vec::<u16>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0135    UIntArray       Vec::<u32>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0136    ULongArray      Vec::<u64>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
...
0139    I128Array       Vec::<i128>     [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0140    U128Array       Vec::<u128>     [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0141    StringArray     Vec::<String>   [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0142    FloatArray      Vec::<f32>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
0143    DoubleArray     Vec::<f64>      [array  ]       [extension]     [$crate::family::NonByte         ]  [cfg(feature = "extensions")]
        }
    };
}
