...
0013    UByte           u8              [scalar ]       [extension]     [Primitive]         [cfg(feature = "extensions")]
0128    UShort          u16             [scalar ]       [extension]     [NonBytePrimitive]  [cfg(feature = "extensions")]
0129    UInt            u32             [scalar ]       [extension]     [NonBytePrimitive]  [cfg(feature = "extensions")]
0130    ULong           u64             [scalar ]       [extension]     [NonBytePrimitive]  [cfg(feature = "extensions")]
0131    Bytes           Vec::<u8>       [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0132    ShortArray      Vec::<i16>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0133    UShortArray     Vec::<u16>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0134    UIntArray       Vec::<u32>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0135    ULongArray      Vec::<u64>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0136    I128            i128            [scalar ]       [extension]     [NonBytePrimitive]  [cfg(feature = "extensions")]
0137    U128            u128            [scalar ]       [extension]     [NonBytePrimitive]  [cfg(feature = "extensions")]
0138    I128Array       Vec::<i128>     [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0139    U128Array       Vec::<u128>     [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0140    StringArray     Vec::<String>   [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0141    FloatArray      Vec::<f32>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
0142    DoubleArray     Vec::<f64>      [array  ]       [extension]     [NonByte]           [cfg(feature = "extensions")]
        }
    };
}
